            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return Promise.all([createPassivePoint(center - 8, center - 8, 0, 6), createActivePoint(23 * 16, center - 8, 0, 6), fireBomb(2, 2, maxEdge - 4, 11 * 16 - 4, 0, 6), fireBomb(2, 21 * 16 + 2, maxEdge - 4, 11 * 16 - 4, 0, 6), fireMovingVerticalLaser(0, 32, 1, 1, 5), fireMovingHorizontalLaser(0, 32, 1, 2, 5)]);
