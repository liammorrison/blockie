            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return Promise.all([createPoint(canvas.width / 2 - 12, canvas.height / 2 - 12, 0, 7), fireMovingHorizontalLaser(0, 16, 0.5, 0, 7), fireMovingVerticalLaser(0, 16, 0.5, 0, 7), fireMovingVerticalLaser(canvas.width - 16, 16, -0.5, 0, 7), fireMovingHorizontalLaser(canvas.height - 16, 16, -0.75, 2, 5)]);
