            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 12:
                        ...
                        _context.next = 15;
                        return Promise.all([createWall(0, 0, fullScreen, 14 * 16), createWall(0, 14 * 16, oneFourth, 20 * 16), createWall(threeFourths, 14 * 16, oneFourth, 20 * 16), createWall(oneFourth, 14 * 16, 6 * 16, 6 * 16), createWall(18 * 16, 14 * 16, 6 * 16, 6 * 16), createWall(oneFourth, 24 * 16, 6 * 16, 8 * 16), createWall(18 * 16, 24 * 16, 6 * 16, 8 * 16), createWall(14 * 16, pointEight, 4 * 16, 2 * 16), fireBomb(14 * 16, 26 * 16, 4 * 16, 4 * 16, 0.5, 0.5), fireBomb(14 * 16, 20 * 16, 4 * 16, 4 * 16, 2, 0.5), fireBomb(14 * 16, 26 * 16, 4 * 16, 4 * 16, 3.5, 0.5), fireBomb(8 * 16, 20 * 16, 4 * 16, 4 * 16, 3.5, 0.5), fireBomb(20 * 16, 20 * 16, 4 * 16, 4 * 16, 3.5, 0.5), createActivePoint(oneHalf - 8, oneHalf - 8, 5)]);
                    ...
                    case 15:
                        ...
                        _context.next = 18;
                        return Promise.all([fireBomb(16, oneEigth, 30 * 16, oneFourth, 0, 1), fireBomb(16, fiveEigths, 30 * 16, oneFourth, 0.15, 1), fireBomb(0, 16, oneEigth, 30 * 16, 2.2, 1), fireBomb(threeEigths, 16, oneFourth, 30 * 16, 2.3, 1), fireBomb(sevenEigths, 16, oneEigth, 30 * 16, 2.45, 1), createActivePoint(oneHalf - 8, 8 * 16, 5.35), fireBomb(oneEigth, 16, oneFourth, 30 * 16, 4.75, 1), fireBomb(fiveEigths, 16, oneFourth, 30 * 16, 4.9, 1), fireBomb(16, 0, 30 * 16, oneEigth, 5.05, 1), fireBomb(16, threeEigths, 30 * 16, oneFourth, 5.2, 1), fireBomb(16, sevenEigths, 30 * 16, oneEigth, 5.35, 1)]);
