...
async function levelFour() {
    try {
        ...
        await Promise.all([
            ...
            createWall(nineSixteenths, 0, oneHalf, fullScreen),
            createActivePoint(oneHalf - 8, oneSixteenth - 8, 0),
...
async function levelSix() {
    try {
        ...
        await Promise.all([
            ...
            fireBomb(0, 0, fullScreen, fullScreen, 2.4, 0.5)
        ]);
...
async function levelSeven() {
    try {
        ...
        await Promise.all([
            createWall(0, 0, fullScreen, sevenSixteenths),
            createWall(0, sevenSixteenths, 13 * 16, oneEigth),
            createWall(nineSixteenths, sevenSixteenths, nineSixteenths, oneEigth),
            createWall(0, nineSixteenths, oneFourth, oneSixteenth),
            createWall(oneFourth, nineSixteenths, 5 * 16, 16),
            createWall(13 * 16, 19 * 16, 5 * 16, 16),
            createWall(nineSixteenths, nineSixteenths, sevenSixteenths, oneSixteenth),
            createWall(0, fiveEigths, oneFourth, oneEigth),
            createWall(13 * 16, fiveEigths, 19 * 16, oneEigth),
            createWall(0, threeFourths, fullScreen, oneSixteenth),
...
async function levelNine() {
    try {
        ...
        await Promise.all([
            ...
            createWall(0, 0, fullScreen, oneSixteenth),
            createWall(0, fiveSixteenths, fullScreen, oneSixteenth),
            createWall(0, oneHalf, fullScreen, oneSixteenth),
            createWall(0, fifteenSixteenths, fullScreen, oneSixteenth),
            createWall(0, 0, oneSixteenth, fullScreen),
            createWall(fifteenSixteenths, 0, oneSixteenth, fullScreen),
...
async function levelEleven() {
    try {
        ...
        await Promise.all([
            ...
            fireBomb(sevenSixteenths, 0, oneEigth, fullScreen, 20.5, 1000000)
        ]);
