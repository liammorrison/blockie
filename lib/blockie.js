            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 6;
                        return Promise.all([loopFireMovingWalls(150, 150, 320, 14, 0.6, 0.1, 1, 1, 3), createWall(0, 0, fullScreen, 10 * 16), createWall(4 * 16, 14 * 16, oneEigth, oneEigth), createWall(24 * 16, 14 * 16, oneEigth, oneEigth), createWall(0, 22 * 16, fullScreen, 10 * 16), createActivePoint(pointOne - 8, oneHalf - 8, 0), createPassivePoint(pointEight - 8, oneHalf - 8, 0, 3), loopFireBombs(0, 10 * 16, oneFourth, oneEigth, 0, 0.7, 0.5), loopFireBombs(0, 14 * 16, oneEigth, oneFourth, 0.55, 0.7, 0.5), loopFireBombs(oneEigth, 18 * 16, oneFourth, oneEigth, 1.1, 0.7, 0.5), loopFireBombs(oneFourth, 10 * 16, oneEigth, oneFourth, 1.65, 0.7, 0.5), loopFireBombs(threeFourths, 10 * 16, oneFourth, oneEigth, 0, 0.7, 0.5), loopFireBombs(sevenEigths, 14 * 16, oneEigth, oneFourth, 0.55, 0.7, 0.5), loopFireBombs(fiveEigths, 18 * 16, oneFourth, oneEigth, 1.1, 0.7, 0.5), loopFireBombs(fiveEigths, 10 * 16, oneEigth, oneFourth, 1.65, 0.7, 0.5)]);
                    ...
                    case 6:
                        ...
                        _context.next = 9;
                        return Promise.all([createWall(0, 0, fullScreen, oneEigth), createWall(0, oneFourth, fullScreen, oneEigth), createWall(0, fiveEigths, fullScreen, oneEigth), createWall(0, sevenEigths, fullScreen, oneEigth), createActivePoint(pointEight - 8, oneHalf - 8, 2), fireBomb(0, oneEigth, 2 * 16, oneEigth, 0, 0.15), fireBomb(2 * 16, oneEigth, 2 * 16, oneEigth, 0.15, 0.15), fireBomb(4 * 16, oneEigth, 2 * 16, oneEigth, 0.3, 0.15), fireBomb(6 * 16, oneEigth, 2 * 16, oneEigth, 0.45, 0.15), fireBomb(8 * 16, oneEigth, 2 * 16, oneEigth, 0.6, 0.15), fireBomb(10 * 16, oneEigth, 2 * 16, oneEigth, 0.75, 0.15), fireBomb(12 * 16, oneEigth, 2 * 16, oneEigth, 0.9, 0.15), fireBomb(14 * 16, oneEigth, 2 * 16, oneEigth, 1.05, 0.15), fireBomb(16 * 16, oneEigth, 2 * 16, oneEigth, 1.2, 0.15), fireBomb(18 * 16, oneEigth, 2 * 16, oneEigth, 1.35, 0.15), fireBomb(20 * 16, oneEigth, 2 * 16, oneEigth, 1.5, 0.15), fireBomb(22 * 16, oneEigth, 2 * 16, oneEigth, 1.65, 0.15), fireBomb(24 * 16, oneEigth, 2 * 16, oneEigth, 1.8, 0.15), fireBomb(26 * 16, oneEigth, 2 * 16, oneEigth, 1.95, 0.15), fireBomb(28 * 16, oneEigth, 2 * 16, oneEigth, 2.1, 0.15), fireBomb(30 * 16, oneEigth, 2 * 16, oneEigth, 2.25, 0.15), fireBomb(0, threeEigths, 2 * 16, oneFourth, 1, 0.15), fireBomb(2 * 16, threeEigths, 2 * 16, oneFourth, 1.15, 0.15), fireBomb(4 * 16, threeEigths, 2 * 16, oneFourth, 1.3, 0.15), fireBomb(6 * 16, threeEigths, 2 * 16, oneFourth, 1.45, 0.15), fireBomb(8 * 16, threeEigths, 2 * 16, oneFourth, 1.6, 0.15), fireBomb(10 * 16, threeEigths, 2 * 16, oneFourth, 1.75, 0.15), fireBomb(12 * 16, threeEigths, 2 * 16, oneFourth, 1.9, 0.15), fireBomb(14 * 16, threeEigths, 2 * 16, oneFourth, 2.05, 0.15), fireBomb(16 * 16, threeEigths, 2 * 16, oneFourth, 2.2, 0.15), fireBomb(18 * 16, threeEigths, 2 * 16, oneFourth, 2.35, 0.15), fireBomb(20 * 16, threeEigths, 2 * 16, oneFourth, 2.5, 0.15), fireBomb(22 * 16, threeEigths, 2 * 16, oneFourth, 2.65, 0.15), fireBomb(24 * 16, threeEigths, 2 * 16, oneFourth, 2.8, 0.15), fireBomb(26 * 16, threeEigths, 2 * 16, oneFourth, 2.95, 0.15), fireBomb(28 * 16, threeEigths, 2 * 16, oneFourth, 3.1, 0.15), fireBomb(30 * 16, threeEigths, 2 * 16, oneFourth, 3.25, 0.15), fireBomb(0, threeFourths, 2 * 16, oneEigth, 0, 0.15), fireBomb(2 * 16, threeFourths, 2 * 16, oneEigth, 0.15, 0.15), fireBomb(4 * 16, threeFourths, 2 * 16, oneEigth, 0.3, 0.15), fireBomb(6 * 16, threeFourths, 2 * 16, oneEigth, 0.45, 0.15), fireBomb(8 * 16, threeFourths, 2 * 16, oneEigth, 0.6, 0.15), fireBomb(10 * 16, threeFourths, 2 * 16, oneEigth, 0.75, 0.15), fireBomb(12 * 16, threeFourths, 2 * 16, oneEigth, 0.9, 0.15), fireBomb(14 * 16, threeFourths, 2 * 16, oneEigth, 1.05, 0.15), fireBomb(16 * 16, threeFourths, 2 * 16, oneEigth, 1.2, 0.15), fireBomb(18 * 16, threeFourths, 2 * 16, oneEigth, 1.35, 0.15), fireBomb(20 * 16, threeFourths, 2 * 16, oneEigth, 1.5, 0.15), fireBomb(22 * 16, threeFourths, 2 * 16, oneEigth, 1.65, 0.15), fireBomb(24 * 16, threeFourths, 2 * 16, oneEigth, 1.8, 0.15), fireBomb(26 * 16, threeFourths, 2 * 16, oneEigth, 1.95, 0.15), fireBomb(28 * 16, threeFourths, 2 * 16, oneEigth, 2.1, 0.15), fireBomb(30 * 16, threeFourths, 2 * 16, oneEigth, 2.25, 0.15)]);
                    ...
                    case 9:
                        ...
                        _context.next = 13;
                        return Promise.all([createWall(0, oneEigth, oneEigth, sevenEigths), createWall(9 * 16, 0, 2 * 16, 4 * 16), createWall(oneFourth, oneEigth, oneEigth, threeFourths), createWall(oneHalf, oneEigth, oneEigth, 10 * 16), createWall(oneHalf, 18 * 16, oneEigth, 14 * 16), createWall(25 * 16, 0, 2 * 16, 4 * 16), createWall(threeFourths, oneEigth, oneEigth, threeFourths), createActivePoint(pointOne - 8, pointOne - 8, 0), createPassivePoint(18 * 16 - 8, oneHalf - 8, 4, 4), loopFireBombs(11 * 16, 0, 14 * 16, 2 * 16, 0, 1, 0.3), loopFireBombs(11 * 16, 2 * 16, 14 * 16, 2 * 16, 0.3, 1, 0.3), loopFireBombs(threeEigths, oneEigth, oneEigth, 2 * 16, 0.6, 1, 0.3), loopFireBombs(fiveEigths, oneEigth, oneEigth, 2 * 16, 0.6, 1, 0.3), loopFireBombs(threeEigths, 6 * 16, oneEigth, 2 * 16, 0.9, 1, 0.3), loopFireBombs(fiveEigths, 6 * 16, oneEigth, 2 * 16, 0.9, 1, 0.3), loopFireBombs(threeEigths, oneFourth, oneEigth, 2 * 16, 1.2, 1, 0.3), loopFireBombs(fiveEigths, oneFourth, oneEigth, 2 * 16, 1.2, 1, 0.3), loopFireBombs(threeEigths, 10 * 16, oneEigth, 2 * 16, 1.5, 1, 0.3), loopFireBombs(fiveEigths, 10 * 16, oneEigth, 2 * 16, 1.5, 1, 0.3), loopFireBombs(threeEigths, threeEigths, oneEigth, 2 * 16, 1.8, 1, 0.3), loopFireBombs(fiveEigths, threeEigths, oneEigth, 2 * 16, 1.8, 1, 0.3), loopFireBombs(threeEigths, 14 * 16, threeEigths, 2 * 16, 2.1, 1, 0.3), loopFireBombs(threeEigths, oneHalf, threeEigths, 2 * 16, 2.4, 1, 0.3)]);
                    ...
                    case 17:
                        ...
                        _context.next = 20;
                        return Promise.all([createWall(0, 2 * 16, 2 * 16, oneHalf), createWall(6 * 16, 2 * 16, 2 * 16, oneEigth), createWall(24 * 16, 2 * 16, 2 * 16, oneEigth), createWall(6 * 16, 14 * 16, 2 * 16, oneEigth), createWall(24 * 16, 14 * 16, 2 * 16, oneEigth), createWall(30 * 16, 2 * 16, 2 * 16, oneHalf), createWall(0, 0, fullScreen, 2 * 16), createWall(2 * 16, 6 * 16, sevenEigths, 2 * 16), createWall(2 * 16, 12 * 16, sevenEigths, 2 * 16), createWall(0, 18 * 16, fullScreen, 14 * 16), fireBomb(oneFourth, 2 * 16, oneHalf, oneEigth, 0.25, 1), fireBomb(oneFourth, 14 * 16, oneHalf, oneEigth, 0.25, 1), fireBomb(oneFourth, 2 * 16, oneHalf, oneEigth, 2.25, 1), fireBomb(2 * 16, oneFourth, sevenEigths, oneEigth, 2.25, 1), fireBomb(oneFourth, 14 * 16, oneHalf, oneEigth, 2.25, 1), createActivePoint(oneHalf - 8, 10 * 16 - 8, 4.5), fireBomb(2 * 16, 2 * 16, oneEigth, oneEigth, 4.5, 1), fireBomb(oneFourth, 2 * 16, oneHalf, oneEigth, 4.5, 1), fireBomb(26 * 16, 2 * 16, oneEigth, oneEigth, 4.5, 1), fireBomb(2 * 16, 14 * 16, oneEigth, oneEigth, 4.5, 1), fireBomb(oneFourth, 14 * 16, oneHalf, oneEigth, 4.5, 1), fireBomb(26 * 16, 14 * 16, oneEigth, oneEigth, 4.5, 1)]);
...
var loopFireMovingBombs = function () {
    var _ref25 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee25(x, y, width, height, xSpeed, ySpeed, initialWaitingSeconds, waitingSeconds, firingSeconds) {
    ...
    return function loopFireMovingBombs(_x46, _x47, _x48, _x49, _x50, _x51, _x52, _x53, _x54) {
...
var fireMovingBomb = function () {
    var _ref26 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26(x, y, width, height, xSpeed, ySpeed, waitingSeconds, firingSeconds) {
        var instance;
    ...
    return function fireMovingBomb(_x55, _x56, _x57, _x58, _x59, _x60, _x61, _x62) {
...
var createWall = function () {
    var _ref27 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee27(x, y, width, height) {
        var instance;
    ...
    return function createWall(_x63, _x64, _x65, _x66) {
...
var loopFireMovingWalls = function () {
    ...
    return function loopFireMovingWalls(_x67, _x68, _x69, _x70, _x71, _x72, _x73, _x74, _x75) {
...
var fireMovingWall = function () {
    ...
    return function fireMovingWall(_x76, _x77, _x78, _x79, _x80, _x81, _x82, _x83) {
...
var playCutscene = function () {
    var _ref30 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee30(scene, secondsPerFrame) {
    ...
    return function playCutscene(_x84, _x85) {
...
function updateAllObjects() {
    allObjects = [waitingTimeouts, passivePoints, activePoints, movingHorizontalLasers, movingVerticalLasers, bombs, movingBombs, walls, movingWalls];
};

function updateAllInteractiveObjects() {
    allObjects = [waitingTimeouts, passivePoints, activePoints, movingHorizontalLasers, movingVerticalLasers, bombs, movingBombs];
};
