            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        promiseOne = fireHorizontalLaser(300, 16, 4);
                        promiseTwo = fireHorizontalLaser(100, 16, 3);
                        _context.next = 5;
...
var fireHorizontalLaser = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(y, height, seconds) {
        var promiseTimer, instance, instanceIndex, timerInsideFunction;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        timerInsideFunction = function timerInsideFunction() {
