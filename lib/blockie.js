            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return Promise.all([createActivePoint(23 * 16, center - 8, 0, 6), fireHorizontalLaser(100, 16, 0, 6)]);
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 4:
                        _context4.next = 6;
                        return new Promise(function (resolve, reject) {
                            var celebration = setTimeout(function () {
                                console.log("shrek");
                                resolve("resolved");
                            }, 2000);
                        });
...
var setWarningTimeouts = function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(instanceAffecting, instanceAffectingObjectArray) {
        var warningSeconds;
