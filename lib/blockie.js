            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 5;
                        return loopFireMovingWalls(14 * 16, 14 * 16, oneEigth, oneEigth, -1, 1, 0, 0, 7);
...
function updateAllInstances() {
    allInstances = [waitingTimeouts, passivePoints, activePoints, movingHorizontalLasers, movingVerticalLasers, bombs, movingBombs, walls, movingWalls];
};

function updateAllInteractiveInstances() {
    allInteractiveInstances = [waitingTimeouts, passivePoints, activePoints, movingHorizontalLasers, movingVerticalLasers, bombs, movingBombs];
};
    ...
    if (gameState === "playing") {
        ...
        for (var _i5 = 0; _i5 < collidingInstances.length; _i5++) {
            if (collidingInstances[_i5].constructor.name === "PassivePoint") {
                ...
                passivePoints.splice(instanceIndex, 1);
            } else if (collidingInstances[_i5].constructor.name === "ActivePoint") {
                //Adds points to the current level's total.
                currentLevelPoints++;
