            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return Promise.all([fireMovingHorizontalLaser(canvas.height - 16, 16, -0.75, 0, 6), fireMovingHorizontalLaser(0, 16, 0.5, 0, 6)]);
...
var setWarningTimers = function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(instanceAffecting) {
        var warningTimerInstance, warningSeconds;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        //Creates an instance and sets all of its initial properties.
                        warningTimerInstance = new warningTimer();
                        ...
                        _context4.next = 5;
                        return new Promise(function (resolve, reject) {
                            warningTimerInstance.timer = setTimeout(function () {
                    ...
                    case 9:
                        return _context4.abrupt("return", new Promise(function (resolve, reject) {
                            warningTimerInstance.timer = setTimeout(function () {
                                ...
                                var warningTimerInstanceIndex = warningTimers.indexOf(warningTimerInstance);
    ...
    return function setWarningTimers(_x) {
...
var createPoint = function () {
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    ...
                    case 2:
                        ...
                        _context5.next = 6;
                        return setWarningTimers(pointInstance);

                    case 6:
                        return _context5.abrupt("return", new Promise(function (resolve, reject) {
                            pointInstance.timer = setTimeout(function () {
                                //Removes the instance from its object array (so it isn't drawn or colliding) once it is "destroyed".
                                var pointInstanceIndex = points.indexOf(pointInstance);
    ...
    return function createPoint(_x2, _x3, _x4, _x5) {
...
var fireHorizontalLaser = function () {
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    ...
                    case 2:
                        ...
                        //Creates an instance and sets all of its initial properties.
                        horizontalLaserInstance = new horizontalLaser(y, height);

                        horizontalLasers.push(horizontalLaserInstance);

                        //Creates the "blinking" effect for warning of a collision.
                        _context6.next = 6;
                        return setWarningTimers(horizontalLaserInstance);

                    case 6:
                        return _context6.abrupt("return", new Promise(function (resolve, reject) {
                            horizontalLaserInstance.timer = setTimeout(function () {
                                //Removes the instance from its object array (so it isn't drawn or colliding) once it is "destroyed".
                                var horizontalLaserInstanceIndex = horizontalLasers.indexOf(horizontalLaserInstance);
    ...
    return function fireHorizontalLaser(_x6, _x7, _x8, _x9) {
...
var fireVerticalLaser = function () {
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                        ...
                        //Creates an instance and sets all of its initial properties.
                        verticalLaserInstance = new verticalLaser(x, width);

                        verticalLasers.push(verticalLaserInstance);

                        //Creates the "blinking" effect for warning of a collision.
                        _context7.next = 6;
                        return setWarningTimers(verticalLaserInstance);

                    case 6:
                        return _context7.abrupt("return", new Promise(function (resolve, reject) {
                            verticalLaserInstance.timer = setTimeout(function () {
                                //Removes the instance from its object array (so it isn't drawn or colliding) once it is "destroyed".
                                var verticalLaserInstanceIndex = verticalLasers.indexOf(verticalLaserInstance);
    ...
    return function fireVerticalLaser(_x10, _x11, _x12, _x13) {
...
var fireMovingHorizontalLaser = function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(y, height, speed, waitingSeconds, activeSeconds) {
        var movingHorizontalLaserInstance;
            ...
            while (1) {
                switch (_context8.prev = _context8.next) {
                    ...
                    case 2:
                        ...
                        //Creates an instance and sets all of its initial properties.
                        movingHorizontalLaserInstance = new movingHorizontalLaser(y, height, speed);

                        movingHorizontalLasers.push(movingHorizontalLaserInstance);

                        //Creates the "blinking" effect for warning of a collision.
                        _context8.next = 6;
                        return setWarningTimers(movingHorizontalLaserInstance);

                    case 6:
                        return _context8.abrupt("return", new Promise(function (resolve, reject) {
                            movingHorizontalLaserInstance.timer = setTimeout(function () {
                                //Removes the instance from its object array (so it isn't drawn or colliding) once it is "destroyed".
                                var movingHorizontalLaserInstanceIndex = movingHorizontalLasers.indexOf(movingHorizontalLaserInstance);
    ...
    return function fireMovingHorizontalLaser(_x14, _x15, _x16, _x17, _x18) {
...
var fireMovingVerticalLaser = function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(x, width, speed, waitingSeconds, activeSeconds) {
        var movingVerticalLaserInstance;
            ...
            while (1) {
                switch (_context9.prev = _context9.next) {
                    ...
                    case 2:
                        ...
                        //Creates an instance and sets all of its initial properties.
                        movingVerticalLaserInstance = new movingVerticalLaser(x, width, speed);

                        movingVerticalLasers.push(movingVerticalLaserInstance);

                        //Creates the "blinking" effect for warning of a collision.
                        _context9.next = 6;
                        return setWarningTimers(movingVerticalLaserInstance);

                    case 6:
                        return _context9.abrupt("return", new Promise(function (resolve, reject) {
                            movingVerticalLaserInstance.timer = setTimeout(function () {
                                //Removes the instance from its object array (so it isn't drawn or colliding) once it is "destroyed".
                                var movingVerticalLaserInstanceIndex = movingVerticalLasers.indexOf(movingVerticalLaserInstance);
    ...
    return function fireMovingVerticalLaser(_x19, _x20, _x21, _x22, _x23) {
...
var fireBomb = function () {
            ...
            while (1) {
                switch (_context10.prev = _context10.next) {
                    ...
                    case 2:
                        ...
                        //Creates an instance and sets all of its initial properties.
                        bombInstance = new bomb(x, y, width, height);

                        bombs.push(bombInstance);

                        //Creates the "blinking" effect for warning of a collision.
                        _context10.next = 6;
                        return setWarningTimers(bombInstance);

                    case 6:
                        return _context10.abrupt("return", new Promise(function (resolve, reject) {
                            instance.timer = setTimeout(function () {
                                //Removes the instance from its object array (so it isn't drawn or colliding) once it is "destroyed".
                                var bombInstanceIndex = bombs.indexOf(bombInstance);
    ...
    return function fireBomb(_x24, _x25, _x26, _x27, _x28, _x29) {
...
var warningTimer = function warningTimer() {
    _classCallCheck(this, warningTimer);
...
function rejectInstances(objectArray) {
    ...
    for (var i = initialArrayLength - 1; i >= 0; i--) {
        ...
        var _instance = objectArray[i];
        _instance.externalReject();
...
function setWaitingTimer(waitingSeconds) {
    //Creates an instance and sets all of its initial properties.
    var waitingTimerInstance = new waitingTimer();
    waitingTimers.push(waitingTimerInstance);

    return new Promise(function (resolve, reject) {
        waitingTimerInstance.timer = setTimeout(function () {
            //Removes the instance from its object array once it is "destroyed".
            var waitingTimerInstanceIndex = waitingTimers.indexOf(waitingTimerInstance);
