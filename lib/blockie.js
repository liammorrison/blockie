            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 5;
                        return Promise.all([createWall(0, oneEigth, oneEigth, 2 * 16), createWall(oneEigth, 0, oneEigth, fullScreen), createWall(oneFourth, oneEigth, oneEigth, 2 * 16), createWall(threeEigths, 0, fiveEigths, fullScreen), createActivePoint(pointOne - 8, pointOne - 8, 0), createPassivePoint(pointThree - 8, pointOne - 8, 0, 8.5), fireMovingBomb(oneFourth, fullScreen, oneEigth, fullScreen, 0, -2, 0, 3.45), fireBomb(oneFourth, 6 * 16, oneEigth, 26 * 16, 3.45, 12), fireMovingBomb(0, fullScreen, oneEigth, fullScreen, 0, -1.7, 4.5, 12), fireBomb(0, 0, oneEigth, oneEigth, 1.3, 12)]);
                    ...
                    case 5:
                        ...
                        _context.next = 9;
                        return Promise.all([createWall(0, oneEigth, 14 * 16, sevenEigths), createWall(18 * 16, 0, 14 * 16, fullScreen), createWall(14 * 16, 25 * 16, oneEigth, 2 * 16), createActivePoint(oneHalf - 8, pointEight - 8, 0), fireMovingBomb(14 * 16, 33 * 16, oneEigth, 34 * 16, 0, -0.45, 0, 20.5), fireBomb(pointFour, 0, oneEigth, fullScreen, 20.5, 1000000)]);
                    ...
                    case 9:
                        ...
                        _context.next = 12;
                        return Promise.all([createWall(0, 0, threeEigths, oneEigth), createWall(fiveEigths, 0, threeEigths, oneEigth), createWall(0, oneEigth, oneEigth, threeFourths), createWall(oneFourth, oneFourth, oneEigth, oneHalf), createWall(fiveEigths, oneFourth, oneEigth, oneHalf), createWall(sevenEigths, oneEigth, oneEigth, threeFourths), createWall(0, sevenEigths, threeEigths, oneEigth), createWall(fiveEigths, sevenEigths, threeEigths, oneEigth), createActivePoint(oneHalf - 8, pointOne - 8, 0), loopFireMovingBombs(oneEigth, oneFourth, oneEigth, 2 * 16, 0, 1.2, 0, 2, 4), loopFireMovingBombs(threeEigths, oneFourth, oneFourth, 2 * 16, 0, 1.86, 0, 1, 2), loopFireMovingBombs(threeEigths, oneFourth, oneFourth, 2 * 16, 0, 1.86, 2, 1, 2), loopFireMovingBombs(threeFourths, oneEigth, oneEigth, 2 * 16, 0, 2.35, 0, 0.1, 2.5), loopFireMovingBombs(threeFourths, oneEigth, oneEigth, 2 * 16, 0, 2.35, 1.2, 0.1, 2.5), loopFireMovingBombs(threeFourths, oneEigth, oneEigth, 2 * 16, 0, 2.35, 2.4, 0.1, 2.5)]);
                    ...
                    case 12:
                        ...
                        _context.next = 16;
                        return Promise.all([createWall(0, 0, 14 * 16, fullScreen), createWall(18 * 16, 0, 14 * 16, fullScreen), createActivePoint(oneHalf - 8, pointEight - 8, 0), fireContinuallyMovingBomb(6 * 16, oneEigth, oneEigth, 2 * 16, 1.79, 0, 0, 2.4), fireContinuallyMovingBomb(6 * 16, pointTwo, oneEigth, 2 * 16, 1.79, 0, 0.6, 2.4), fireContinuallyMovingBomb(6 * 16, oneFourth, oneEigth, 2 * 16, 1.79, 0, 1.2, 2.4), fireContinuallyMovingBomb(6 * 16, pointThree, oneEigth, 2 * 16, 1.79, 0, 1.8, 2.4), fireContinuallyMovingBomb(22 * 16, threeEigths, oneEigth, 2 * 16, -1.79, 0, 0, 2.4), fireContinuallyMovingBomb(22 * 16, pointFour, oneEigth, 2 * 16, -1.79, 0, 0.6, 2.4), fireContinuallyMovingBomb(22 * 16, oneHalf, oneEigth, 2 * 16, -1.79, 0, 1.2, 2.4), fireContinuallyMovingBomb(22 * 16, pointFive, oneEigth, 2 * 16, -1.79, 0, 1.8, 2.4), fireContinuallyMovingBomb(6 * 16, fiveEigths, oneEigth, 2 * 16, 1.79, 0, 0, 2.4), fireContinuallyMovingBomb(6 * 16, pointSix, oneEigth, 2 * 16, 1.79, 0, 0.6, 2.4), fireContinuallyMovingBomb(6 * 16, threeFourths, oneEigth, 2 * 16, 1.79, 0, 1.2, 2.4), fireContinuallyMovingBomb(6 * 16, pointSeven, oneEigth, 2 * 16, 1.79, 0, 1.8, 2.4)]);
                    ...
                    case 16:
                        ...
                        _context.next = 19;
                        return Promise.all([createWall(oneEigth, 0, pointThree, oneEigth), createWall(pointFive, 0, threeEigths, oneEigth), createWall(oneEigth, sevenEigths, pointThree, oneEigth), createWall(pointFive, sevenEigths, threeEigths, oneEigth), createWall(0, 0, oneEigth, fullScreen), createWall(sevenEigths, 0, oneEigth, fullScreen), createActivePoint(oneHalf - 8, pointOne - 8, 0), fireContinuallyMovingBomb(oneEigth, oneEigth, threeFourths, pointOne, 0, 1.4, 0, 4.2), fireContinuallyMovingBomb(oneEigth, pointSeven, threeFourths, pointOne, 0, -1.4, 0, 4.2), fireContinuallyMovingBomb(threeFourths, oneEigth, oneEigth, threeFourths, -1.28, 0, 0, 4.2)]);
                    ...
                    case 19:
                        ...
                        _context.next = 23;
                        return Promise.all([createWall(oneEigth, oneEigth, threeFourths, oneEigth), createWall(oneEigth, oneFourth, oneEigth, oneEigth), createWall(threeEigths, oneFourth, oneFourth, oneEigth), createWall(threeFourths, oneFourth, oneFourth, oneEigth), createWall(oneEigth, oneHalf, pointThree, oneEigth), createWall(pointFive, oneHalf, pointThree, oneEigth), createWall(0, fiveEigths, sevenEigths, oneFourth), createWall(sevenEigths, pointSeven, oneEigth, pointOne), fireMovingActivePoint(pointEight - 8, pointEight - 8, -0.42, 0, 0), createPassivePoint(pointEight - 8, pointTwo - 8, 3, 7), loopFireMovingBombs(fullScreen, threeEigths, oneEigth, oneEigth, -9, 0, 0, 0, 1), fireBomb(0, sevenEigths, oneEigth, oneEigth, 0, 19.3)]);
