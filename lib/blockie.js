            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 5;
                        return Promise.all([createWall(0, 0, fullScreen, threeFourths), createPassivePoint(pointTwo - 8, sevenEigths - 8, 0, 10), loopFireBombs(oneHalf - 16, threeFourths, 32, oneFourth, 0, 1, 1), createActivePoint(sevenEigths - 8, sevenEigths - 8, 3)]);
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _context4.next = 6;
                        return Promise.all([createWall(threeEigths, 0, 2 * 16, sevenEigths), createWall(oneEigth, 0, oneFourth, 14 * 16), createWall(oneEigth, 18 * 16, oneFourth, 10 * 16), createWall(18 * 16, 0, 14 * 16, fullScreen), createActivePoint(pointOne - 8, pointOne - 8, 0), createPassivePoint(pointOne - 8, pointEight - 8, 0, 9), fireMovingVerticalLaser(27 * 16, 16, -1, 2, 9), fireMovingVerticalLaser(29 * 16, 16, -1, 2, 9), fireMovingVerticalLaser(fullScreen - 16, 16, -1, 2, 9)]);
                    ...
                    case 6:
                        ...
                        _context4.next = 9;
                        return Promise.all([createWall(oneEigth, 0, 10 * 16, sevenEigths), createWall(18 * 16, 0, oneHalf, fullScreen), createActivePoint(oneHalf - 8, pointOne - 8, 0), loopFireBombs(0, 0, oneEigth, oneEigth, 0, 0.5, 0.5), loopFireBombs(0, oneEigth, oneEigth, oneEigth, 0.5, 0.5, 0.5), loopFireBombs(0, oneFourth, oneEigth, oneEigth, 1, 0.5, 0.5), loopFireBombs(0, threeEigths, oneEigth, oneEigth, 1.5, 0.5, 0.5), loopFireBombs(0, oneHalf, oneEigth, oneEigth, 0, 0.5, 0.5), loopFireBombs(0, fiveEigths, oneEigth, oneEigth, 0.5, 0.5, 0.5), loopFireBombs(0, threeFourths, oneEigth, oneEigth, 1, 0.5, 0.5), loopFireBombs(0, sevenEigths, oneEigth, oneEigth, 1.5, 0.5, 0.5), loopFireBombs(14 * 16, 0, oneEigth, oneEigth, 1.5, 0.5, 0.5), loopFireBombs(14 * 16, oneEigth, oneEigth, oneEigth, 1, 0.5, 0.5), loopFireBombs(14 * 16, oneFourth, oneEigth, oneEigth, 0.5, 0.5, 0.5), loopFireBombs(14 * 16, threeEigths, oneEigth, oneEigth, 0, 0.5, 0.5), loopFireBombs(14 * 16, oneHalf, oneEigth, oneEigth, 1.5, 0.5, 0.5), loopFireBombs(14 * 16, fiveEigths, oneEigth, oneEigth, 1, 0.5, 0.5), loopFireBombs(14 * 16, threeFourths, oneEigth, oneEigth, 0.5, 0.5, 0.5), loopFireBombs(14 * 16, sevenEigths, oneEigth, oneEigth, 0, 0.5, 0.5)]);
                    ...
                    case 9:
                        ...
                        _context4.next = 12;
                        return Promise.all([createWall(0, 0, 14 * 16, fullScreen), createWall(18 * 16, 0, 14 * 16, oneFourth), createWall(18 * 16, oneFourth, 2 * 16, 12 * 16), createWall(18 * 16, threeFourths, 6 * 16, oneFourth), createWall(threeFourths, oneFourth, oneFourth, threeFourths), createActivePoint(oneHalf - 8, 28 * 16 - 8, 0), createPassivePoint(22 * 16 - 8, 10 * 16 - 8, 0, 5)]);
                    ...
                    case 12:
                        ...
                        _context4.next = 15;
                        return Promise.all([createWall(0, 0, fullScreen, 8 * 16), createWall(0, 8 * 16, oneFourth, 26 * 16), createWall(threeFourths, 8 * 16, oneFourth, 26 * 16), createWall(oneFourth, 8 * 16, 6 * 16, 6 * 16), createWall(18 * 16, 8 * 16, 6 * 16, 6 * 16), createWall(oneFourth, 18 * 16, 6 * 16, 14 * 16), createWall(18 * 16, 18 * 16, 6 * 16, 14 * 16), createWall(14 * 16, 30 * 16, 4 * 16, 2 * 16), fireBomb(14 * 16, 26 * 16, 4 * 16, 4 * 16, 0.7, 0.7), fireBomb(14 * 16, 20 * 16, 4 * 16, 4 * 16, 1.4, 0.7), fireBomb(14 * 16, 14 * 16, 4 * 16, 4 * 16, 2.1, 0.7), fireBomb(8 * 16, 14 * 16, 4 * 16, 4 * 16, 2.1, 0.7), fireBomb(20 * 16, 14 * 16, 4 * 16, 4 * 16, 2.1, 0.7), fireMovingHorizontalLaser(0, 32, 2, 2.1, 10), createActivePoint(oneHalf - 8, oneHalf - 8, 3)]);
                    ...
                    case 15:
                        ...
                        _context4.next = 18;
                        return Promise.all([fireBomb(16, 0, 30 * 16, oneEigth, 0, 1), fireBomb(16, threeEigths, 30 * 16, oneFourth, 0.15, 1), fireBomb(16, sevenEigths, 30 * 16, oneEigth, 0.3, 1), fireBomb(0, 16, oneEigth, 30 * 16, 2.45, 1), fireBomb(threeEigths, 16, oneFourth, 30 * 16, 2.6, 1), fireBomb(sevenEigths, 16, oneEigth, 30 * 16, 2.75, 1), createActivePoint(oneHalf - 8, oneHalf - 8, 7), fireBomb(oneEigth, 16, oneFourth, 30 * 16, 4.75, 1), fireBomb(fiveEigths, 16, oneFourth, 30 * 16, 4.9, 1), fireBomb(16, oneEigth, 30 * 16, oneFourth, 5.05, 1), fireBomb(16, fiveEigths, 30 * 16, oneFourth, 5.2, 1)]);
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        ...
                        _context5.next = 5;
                        return Promise.all([createWall(0, 0, fullScreen, oneFourth), createWall(0, oneFourth, oneFourth, oneHalf), createWall(threeFourths, oneFourth, oneFourth, oneHalf), createWall(0, threeFourths, 14 * 16, oneEigth), createWall(18 * 16, threeFourths, 14 * 16, oneEigth), createActivePoint(oneEigth - 8, pointEight - 8, 0), createPassivePoint(sevenEigths - 8, pointEight - 8, 2.5, 7)]);
                    ...
                    case 5:
                        ...
                        _context5.next = 8;
                        return Promise.all([createWall(oneFourth, oneFourth, 6 * 16, threeFourths), createWall(14 * 16, 12 * 16, 4 * 16, 20 * 16), createWall(18 * 16, oneFourth, 6 * 16, threeFourths), createActivePoint(sevenEigths - 8, sevenEigths - 8, 0), createPassivePoint(oneHalf - 8, pointThree - 8, 0, 7), loopFireBombs(0, oneFourth, oneFourth, 2 * 16, 1, 0, 1), loopFireBombs(0, oneHalf, oneFourth, 2 * 16, 0, 0, 1), loopFireBombs(0, threeFourths, oneFourth, 2 * 16, 1, 0, 1), fireMovingHorizontalLaser(0, 32, 1.4, 6.5, 10)]);
                    ...
                    case 8:
                        ...
                        _context5.next = 12;
                        return Promise.all([createWall(0, 0, fullScreen, 2 * 16), createWall(0, 6 * 16, fullScreen, 2 * 16), createWall(0, 12 * 16, fullScreen, 2 * 16), createWall(0, 18 * 16, fullScreen, 2 * 16), createWall(0, 24 * 16, fullScreen, 2 * 16), createWall(0, 30 * 16, fullScreen, 2 * 16), createWall(0, 0, 2 * 16, fullScreen), createWall(6 * 16, 0, 2 * 16, fullScreen), createWall(12 * 16, 0, 2 * 16, fullScreen), createWall(18 * 16, 0, 2 * 16, fullScreen), createWall(24 * 16, 0, 2 * 16, fullScreen), createWall(30 * 16, 0, 2 * 16, fullScreen), createActivePoint(4 * 16 - 8, 4 * 16 - 8, 0), createPassivePoint(4 * 16 - 8, 28 * 16 - 8, 0, 17), createPassivePoint(oneHalf - 8, oneHalf - 8, 7, 7), loopFireBombs(8 * 16, 2 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(20 * 16, 2 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(2 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(8 * 16, 8 * 16, 4 * 16, 4 * 16, 2, 2, 1), loopFireBombs(14 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(20 * 16, 8 * 16, 4 * 16, 4 * 16, 2, 2, 1), loopFireBombs(26 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(8 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(14 * 16, 14 * 16, 4 * 16, 4 * 16, 2, 2, 1), loopFireBombs(20 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(2 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(8 * 16, 20 * 16, 4 * 16, 4 * 16, 2, 2, 1), loopFireBombs(14 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(20 * 16, 20 * 16, 4 * 16, 4 * 16, 2, 2, 1), loopFireBombs(26 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(8 * 16, 26 * 16, 4 * 16, 4 * 16, 0, 2, 1), loopFireBombs(20 * 16, 26 * 16, 4 * 16, 4 * 16, 0, 2, 1)]);
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        ...
                        _context6.next = 5;
                        return Promise.all([createWall(0, 6 * 16, 26 * 16, oneFourth), createWall(0, 14 * 16, 14 * 16, 4 * 16), createWall(0, 18 * 16, fullScreen, 14 * 16), createWall(0, 0, 2 * 16, 6 * 16), createWall(2 * 16, 0, 30 * 16, 2 * 16), createWall(30 * 16, 2 * 16, 2 * 16, oneHalf), createWall(17 * 16, 2 * 16, 2 * 16, 4 * 16), createWall(26 * 16, threeEigths, oneEigth, 2 * 16), createActivePoint(oneHalf - 8, oneHalf - 8, 0), loopFireBombs(7 * 16, 2 * 16, 10 * 16, 4 * 16, 0, 0.5, 1), loopFireBombs(26 * 16, 2 * 16, 4 * 16, 10 * 16, 0, 0.5, 1)]);
                    ...
                    case 5:
                        ...
                        _context6.next = 8;
                        return Promise.all([createWall(0, 0, fullScreen, oneFourth), createWall(0, oneFourth, oneFourth, oneHalf), createWall(threeFourths, oneFourth, oneFourth, oneHalf), createWall(0, threeFourths, 14 * 16, oneEigth), createWall(18 * 16, threeFourths, 14 * 16, oneEigth), createActivePoint(pointOne - 8, pointEight - 8, 0), loopFireBombs(oneEigth, sevenEigths, 10 * 16, 4 * 16, 0, 0.5, 1), loopFireBombs(18 * 16, sevenEigths, 10 * 16, 4 * 16, 0, 0.5, 1), createPassivePoint(pointEight - 8, pointEight - 8, 2.5, 7)]);
                    ...
                    case 8:
                        ...
                        _context6.next = 11;
                        return Promise.all([createWall(0, 0, 14 * 16, sevenEigths), createWall(14 * 16, 0, oneEigth, 14 * 16), createWall(18 * 16, 0, 14 * 16, fullScreen), createActivePoint(oneHalf - 8, oneHalf - 8, 0), fireMovingHorizontalLaser(0, 16, 0.7, 0, 10), fireMovingHorizontalLaser(31 * 16, 16, -1.6, 2, 10)]);
                    ...
                    case 11:
                        ...
                        _context6.next = 14;
                        return Promise.all([createActivePoint(pointOne - 8, pointEight - 8, 0), fireBomb(15 * 16, 15 * 16, 2 * 16, 2 * 16, 0.15, 0.5), fireBomb(14 * 16, 14 * 16, 4 * 16, 4 * 16, 0.3, 0.5), fireBomb(13 * 16, 13 * 16, 6 * 16, 6 * 16, 0.45, 0.5), fireBomb(12 * 16, 12 * 16, 8 * 16, 8 * 16, 0.6, 0.5), fireBomb(11 * 16, 11 * 16, 10 * 16, 10 * 16, 0.75, 0.5), fireBomb(10 * 16, 10 * 16, 12 * 16, 12 * 16, 0.9, 0.5), fireBomb(9 * 16, 9 * 16, 14 * 16, 14 * 16, 1.05, 0.5), fireBomb(8 * 16, 8 * 16, 16 * 16, 16 * 16, 1.2, 0.5), fireBomb(7 * 16, 7 * 16, 18 * 16, 18 * 16, 1.35, 0.5), fireBomb(6 * 16, 6 * 16, 20 * 16, 20 * 16, 1.5, 0.5), fireBomb(5 * 16, 5 * 16, 22 * 16, 22 * 16, 1.65, 0.5), fireBomb(4 * 16, 4 * 16, 24 * 16, 24 * 16, 1.8, 0.5), fireBomb(3 * 16, 3 * 16, 26 * 16, 26 * 16, 1.95, 0.5), fireBomb(2 * 16, 2 * 16, 28 * 16, 28 * 16, 2.1, 0.5), fireBomb(1 * 16, 1 * 16, 30 * 16, 30 * 16, 2.25, 0.5), fireBomb(0, 0, 32 * 16, 32 * 16, 2.4, 0.5)]);
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        ...
                        _context7.next = 5;
                        return Promise.all([createWall(0, 0, fullScreen, 14 * 16), createWall(0, 14 * 16, 14 * 16, oneEigth), createWall(18 * 16, 14 * 16, 18 * 16, oneEigth), createWall(0, 18 * 16, fullScreen, 2 * 16), createWall(0, 20 * 16, oneFourth, oneEigth), createWall(12 * 16, 20 * 16, 20 * 16, 4 * 16), createWall(0, 24 * 16, fullScreen, 2 * 16), createWall(0, 26 * 16, 2 * 16, oneEigth), createWall(6 * 16, 26 * 16, 26 * 16, oneEigth), createWall(0, 30 * 16, fullScreen, 2 * 16), createActivePoint(oneEigth - 8, sevenEigths - 8, 0)]);
                    ...
                    case 11:
                        ...
                        _context7.next = 15;
                        return Promise.all([createWall(0, 0, fullScreen, 2 * 16), createWall(0, 6 * 16, fullScreen, 2 * 16), createWall(0, 12 * 16, fullScreen, 2 * 16), createWall(0, 18 * 16, fullScreen, 2 * 16), createWall(0, 24 * 16, fullScreen, 2 * 16), createWall(0, 30 * 16, fullScreen, 2 * 16), createWall(0, 0, 2 * 16, fullScreen), createWall(6 * 16, 0, 2 * 16, fullScreen), createWall(12 * 16, 0, 2 * 16, fullScreen), createWall(18 * 16, 0, 2 * 16, fullScreen), createWall(24 * 16, 0, 2 * 16, fullScreen), createWall(30 * 16, 0, 2 * 16, fullScreen), createActivePoint(oneEigth - 8, oneEigth - 8), createPassivePoint(oneEigth - 8, oneHalf - 8, 5, 7), loopFireBombs(2 * 16, 2 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(8 * 16, 2 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(14 * 16, 2 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(20 * 16, 2 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(26 * 16, 2 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(2 * 16, 8 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(8 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(14 * 16, 8 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(20 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(26 * 16, 8 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(2 * 16, 14 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(8 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(14 * 16, 14 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(20 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(26 * 16, 14 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(2 * 16, 20 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(8 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(14 * 16, 20 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(20 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(26 * 16, 20 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(2 * 16, 26 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(8 * 16, 26 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(14 * 16, 26 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5), loopFireBombs(20 * 16, 26 * 16, 4 * 16, 4 * 16, 0, 1, 0.5), loopFireBombs(26 * 16, 26 * 16, 4 * 16, 4 * 16, 1.25, 1, 0.5)]);
                    ...
                    case 15:
                        ...
                        _context7.next = 18;
                        return Promise.all([createWall(0, 0, fullScreen, 2 * 16), createWall(0, 6 * 16, fullScreen, 2 * 16), createWall(0, 12 * 16, fullScreen, 2 * 16), createWall(0, 18 * 16, fullScreen, 2 * 16), createWall(0, 24 * 16, fullScreen, 2 * 16), createWall(0, 30 * 16, fullScreen, 2 * 16), createWall(0, 0, 2 * 16, fullScreen), createWall(6 * 16, 0, 2 * 16, fullScreen), createWall(12 * 16, 0, 2 * 16, fullScreen), createWall(18 * 16, 0, 2 * 16, fullScreen), createWall(24 * 16, 0, 2 * 16, fullScreen), createWall(30 * 16, 0, 2 * 16, fullScreen), createActivePoint(oneEigth - 8, sevenEigths - 8, 0), loopFireBombs(8 * 16, 2 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(14 * 16, 2 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(20 * 16, 2 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(2 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(8 * 16, 8 * 16, 4 * 16, 4 * 16, 1, 0.5, 0.5), loopFireBombs(14 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(20 * 16, 8 * 16, 4 * 16, 4 * 16, 1, 0.5, 0.5), loopFireBombs(26 * 16, 8 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(2 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(8 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(20 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(26 * 16, 14 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(2 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(8 * 16, 20 * 16, 4 * 16, 4 * 16, 1, 0.5, 0.5), loopFireBombs(14 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(20 * 16, 20 * 16, 4 * 16, 4 * 16, 1, 0.5, 0.5), loopFireBombs(26 * 16, 20 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(8 * 16, 26 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(14 * 16, 26 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5), loopFireBombs(20 * 16, 26 * 16, 4 * 16, 4 * 16, 0, 0.5, 0.5)]);
...
var createActivePoint = function () {
    var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(x, y, waitingSeconds) {
        var instance;
...
var loopFireMovingHorizontalLasers = function () {
    var _ref19 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(y, height, speed, initialWaitingSeconds, waitingSeconds, firingSeconds) {
    ...
    return function loopFireMovingHorizontalLasers(_x11, _x12, _x13, _x14, _x15, _x16) {
...
var fireMovingHorizontalLaser = function () {
    var _ref20 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(y, height, speed, waitingSeconds, firingSeconds) {
        var instance;
    ...
    return function fireMovingHorizontalLaser(_x17, _x18, _x19, _x20, _x21) {
...
var loopFireMovingVerticalLasers = function () {
    var _ref21 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21(x, width, speed, initialWaitingSeconds, waitingSeconds, firingSeconds) {
    ...
    return function loopFireMovingVerticalLasers(_x22, _x23, _x24, _x25, _x26, _x27) {
...
var fireMovingVerticalLaser = function () {
    var _ref22 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee22(x, width, speed, waitingSeconds, firingSeconds) {
        var instance;
    ...
    return function fireMovingVerticalLaser(_x28, _x29, _x30, _x31, _x32) {
...
var loopFireBombs = function () {
    var _ref23 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee23(x, y, width, height, initialWaitingSeconds, waitingSeconds, firingSeconds) {
    ...
    return function loopFireBombs(_x33, _x34, _x35, _x36, _x37, _x38, _x39) {
...
var fireBomb = function () {
    var _ref24 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee24(x, y, width, height, waitingSeconds, firingSeconds) {
        var instance;
    ...
    return function fireBomb(_x40, _x41, _x42, _x43, _x44, _x45) {
...
var createWall = function () {
    var _ref25 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee25(x, y, width, height) {
        var instance;
    ...
    return function createWall(_x46, _x47, _x48, _x49) {
...
var playCutscene = function () {
    var _ref26 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26(scene, secondsPerFrame) {
    ...
    return function playCutscene(_x50, _x51) {
...
function updateAllObjects() {
    allObjects = [waitingTimeouts, passivePoints, activePoints, movingHorizontalLasers, movingVerticalLasers, bombs, walls];
};

function updateAllInteractiveObjects() {
    allObjects = [waitingTimeouts, passivePoints, activePoints, movingHorizontalLasers, movingVerticalLasers, bombs];
};
