            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 5;
                        return Promise.all([createWall(0, 0, fullScreen, fiveEigths), createPassivePoint(pointTwo - 8, pointSeven - 8, 0, 10), loopFireVerticalLasers(oneHalf - 8, 16, 2, 2), createActivePoint(pointSeven - 8, pointSeven - 8, 3)]);
...
var fireHorizontalLaser = function () {
    ...
    return function fireHorizontalLaser(_x9, _x10, _x11, _x12) {
        return _ref8.apply(this, arguments);
    };
}();

var loopFireVerticalLasers = function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(x, width, waitingSeconds, firingSeconds) {
    ...
    return function loopFireVerticalLasers(_x13, _x14, _x15, _x16) {
...
var fireVerticalLaser = function () {
    ...
    return function fireVerticalLaser(_x17, _x18, _x19, _x20) {
...
var fireMovingHorizontalLaser = function () {
    ...
    return function fireMovingHorizontalLaser(_x21, _x22, _x23, _x24, _x25) {
...
var fireMovingVerticalLaser = function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(x, width, speed, waitingSeconds, firingSeconds) {
        var instance;
    ...
    return function fireMovingVerticalLaser(_x26, _x27, _x28, _x29, _x30) {
...
var fireBomb = function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(x, y, width, height, waitingSeconds, firingSeconds) {
        var instance;
    ...
    return function fireBomb(_x31, _x32, _x33, _x34, _x35, _x36) {
...
var createWall = function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(x, y, width, height) {
        var instance;
    ...
    return function createWall(_x37, _x38, _x39, _x40) {
    ...
    if (gameState === "playing") {
        ...
        if (!recoveringFromDash) {
            ...
            if (preventingMovement) {
                ...
                var xChange = Math.min(blockie.dx - xTestingDistance, Math.sign(blockie.dx));
                var yChange = Math.min(blockie.dy - yTestingDistance, Math.sign(blockie.dy));
