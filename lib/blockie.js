...
function initializeLevelMenu() {
    ...
    function beginSelectedLevel(iconNum) {
        ...
        for (var _i = 0; _i < numUnlockedLevels; _i++) {
            menuIconArray[_i].style.visibility = "hidden";
        };

        //Removes all menu-specific eventListeners and timers.

        var _loop = function _loop(_i2) {
            menuIconArray[_i2].removeEventListener("click", function () {
        ...
        var _loop2 = function _loop2(_i3) {
            menuIconArray[_i3].removeEventListener("mouseover", function () {
                if (followMouse) {
    ...
    var _loop3 = function _loop3(_i4) {
        menuIconArray[_i4].addEventListener("click", function () {
    ...
    var _loop4 = function _loop4(_i5) {
        menuIconArray[_i5].addEventListener("mouseover", function () {
            if (followMouse) {
