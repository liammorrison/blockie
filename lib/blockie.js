            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 12:
                        ...
                        _context.next = 16;
                        return Promise.all([createWall(0, 0, 14 * 16, oneEigth), createWall(0, oneEigth, sevenEigths, 10 * 16), createWall(oneEigth, 14 * 16, 10 * 16, oneEigth), createWall(oneEigth, 18 * 16, threeFourths, 10 * 16), createActivePoint(pointOne - 8, oneHalf - 8, 0), createPassivePoint(oneHalf - 8, oneHalf - 8, 5, 144), loopFireMovingWalls(sevenEigths, -3 * 16, oneEigth, 2 * 16, 0, 2, 0, 1, 2.31), loopFireMovingWalls(sevenEigths, 33 * 16, oneEigth, 2 * 16, 0, -2, 0, 1, 2.31), loopFireMovingWalls(13 * 16, 14 * 16, 2 * 16, oneEigth, 2, 0, 0.67, 1.56, 1.75), loopFireMovingWalls(-3 * 16, sevenEigths, 2 * 16, oneEigth, 2, 0, 1.7, 1, 2.31), loopFireMovingWalls(33 * 16, sevenEigths, 2 * 16, oneEigth, -2, 0, 1.7, 1, 2.31)]);
                    ...
                    case 16:
                        ...
                        _context.next = 20;
                        return Promise.all([fireMovingWall(-33 * 16, 0, fullScreen, fullScreen, 1.2, 0, 0.5, 15), createWall(oneEigth, 0, oneEigth, threeEigths), createWall(oneEigth, fiveEigths, oneEigth, threeEigths), createWall(oneFourth, 0, oneEigth, oneFourth), createWall(oneFourth, oneHalf, oneEigth, oneHalf), createWall(threeEigths, 0, oneEigth, oneEigth), createWall(threeEigths, threeEigths, oneEigth, fiveEigths), createWall(oneHalf, 0, oneEigth, oneFourth), createWall(oneHalf, oneHalf, oneEigth, oneHalf), createWall(fiveEigths, 0, oneEigth, oneEigth), createWall(fiveEigths, threeEigths, oneEigth, fiveEigths), createWall(threeFourths, oneFourth, oneEigth, threeFourths), createWall(sevenEigths, oneEigth, oneEigth, sevenEigths), createActivePoint(pointEight - 8, pointOne - 8, 5.1)]);
                    ...
                    case 20:
                        ...
                        _context.next = 24;
                        return Promise.all([createWall(0, 0, sevenEigths, oneEigth), fireContinuallyMovingWall(-sevenEigths, oneEigth, sevenEigths, oneEigth, 1.5, 0, 0, 4.98), fireContinuallyMovingWall(oneEigth, oneEigth, sevenEigths, oneEigth, 1.5, 0, 0, 4.98)]);
...
function gameLoop() {
    ...
    if (gameState === "playing") {
        ...
        for (var _i5 = 0; _i5 < collidingInstances.length; _i5++) {
            if (collidingInstances[_i5].constructor.name === "PassivePoint") {
                //Adds points to the current level's total.
                currentLevelPoints++;

                //Resolves the PassivePoint's Promise and destroys the instance once it is touched.
                var collidingPoint = collidingInstances[_i5];
                collidingPoint.externalResolve();
                clearTimeout(collidingPoint.timeout);
                var instanceIndex = passivePoints.indexOf(collidingPoint);
                passivePoints.splice(instanceIndex, 1);
            } else if (collidingInstances[_i5].constructor.name === "MovingPassivePoint") {
                //Adds points to the current level's total.
                currentLevelPoints++;

                //Resolves the PassivePoint's Promise and destroys the instance once it is touched.
                var _collidingPoint = collidingInstances[_i5];
            ...
            } else if (collidingInstances[_i5].constructor.name === "ActivePoint" || collidingInstances[_i5].constructor.name === "MovingActivePoint") {
                //Adds points to the current level's total.
                currentLevelPoints++;

                //Stops all currently-running timeouts so that they stop hurting performance and don't execute after resetting.
                for (var _i6 = 0; _i6 < currentTimeouts.length; _i6++) {
                    clearTimeout(currentTimeouts[_i6]);
                };

                currentTimeouts.splice(0);

                //Stops all currently-running timeouts so that they stop hurting performance and don't execute after resetting.
                for (var _i7 = 0; _i7 < currentIntervals.length; _i7++) {
                    clearInterval(currentIntervals[_i7]);
                };
                ...
                updateAllInstances();
                for (var _i8 = 0; _i8 < allInstances.length; _i8++) {
                    resolveInstances(allInstances[_i8]);
                };
