            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 5;
                        return Promise.all([createWall(0, 0, threeEigths, fullScreen), createWall(fiveEigths, 0, threeEigths, fullScreen), createActivePoint(oneHalf - 8, pointOne - 8, 0), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 0, 0, 12), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 1.5, 0, 12), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 3, 0, 12), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 4.5, 0, 12), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 6, 0, 12), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 7.5, 0, 12), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 9, 0, 12), loopFireMovingWalls(threeEigths, -2 * 16, oneFourth, 2 * 16, 0, 1.5, 10.5, 0, 12)]);
                    ...
                    case 5:
                        ...
                        _context.next = 8;
                        return Promise.all([createWall(0, 0, 2 * 16, fullScreen), createWall(2 * 16, 0, 10 * 16, 6 * 16), createWall(20 * 16, 0, 10 * 16, 6 * 16), createWall(2 * 16, 13 * 16, 10 * 16, 6 * 16), createWall(20 * 16, 13 * 16, 10 * 16, 6 * 16), createWall(2 * 16, 26 * 16, 10 * 16, 6 * 16), createWall(20 * 16, 26 * 16, 10 * 16, 6 * 16), createWall(30 * 16, 0, 2 * 16, fullScreen), createActivePoint(oneHalf - 8, pointEight - 8, 0), fireContinuallyMovingWall(2 * 16, 6 * 16, 7 * 17, 7 * 16, 1.5, 0, 0, 1.25), fireContinuallyMovingWall(23 * 16, 6 * 16, 7 * 17, 7 * 16, -1.5, 0, 0, 1.25), fireContinuallyMovingWall(2 * 16, 19 * 16, 7 * 16, 7 * 16, 1.5, 0, 0, 1.25), fireContinuallyMovingWall(23 * 16, 19 * 16, 7 * 16, 7 * 16, -1.5, 0, 0, 1.25)]);
                    ...
                    case 12:
                        ...
                        _context.next = 16;
                        return Promise.all([createWall(0, 0, 14 * 16, oneEigth), createWall(0, oneEigth, sevenEigths, 10 * 16), createWall(oneEigth, 14 * 16, 10 * 16, oneEigth), createWall(oneEigth, 18 * 16, threeFourths, 10 * 16), createActivePoint(pointOne - 8, oneHalf - 8, 0), createPassivePoint(oneHalf - 8, oneHalf - 8, 5, 144), loopFireMovingWalls(sevenEigths, -3 * 16, oneEigth, 2 * 16, 0, 2, 0, 1, 2.31), loopFireMovingWalls(sevenEigths, 33 * 16, oneEigth, 2 * 16, 0, -2, 0, 1, 2.31), loopFireMovingWalls(13 * 16, 14 * 16, 2 * 16, oneEigth, 2, 0, 0.65, 1.56, 1.75), loopFireMovingWalls(-3 * 16, sevenEigths, 2 * 16, oneEigth, 2, 0, 1.7, 1, 2.31), loopFireMovingWalls(33 * 16, sevenEigths, 2 * 16, oneEigth, -2, 0, 1.7, 1, 2.31)]);
                    ...
                    case 16:
                        ...
                        _context.next = 20;
                        return Promise.all([fireMovingWall(-33 * 16, 0, fullScreen, fullScreen, 1.2, 0, 0.5, 15), fireMovingWall(0, 0, 2 * 16, threeEigths, 0, -0.2, 0, 10), fireMovingWall(0, fiveEigths, 2 * 16, fullScreen, 0, -0.2, 0, 10), fireMovingWall(2 * 16, 0, 2 * 16, threeEigths, 0, -0.35, 0, 10), fireMovingWall(2 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.35, 0, 10), fireMovingWall(4 * 16, 0, 2 * 16, threeEigths, 0, -0.45, 0, 10), fireMovingWall(4 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.45, 0, 10), fireMovingWall(6 * 16, 0, 2 * 16, threeEigths, 0, -0.5, 0, 10), fireMovingWall(6 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.5, 0, 10), fireMovingWall(8 * 16, 0, 2 * 16, threeEigths, 0, -0.55, 0, 10), fireMovingWall(8 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.55, 0, 10), fireMovingWall(10 * 16, 0, 2 * 16, threeEigths, 0, -0.5, 0, 10), fireMovingWall(10 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.5, 0, 10), fireMovingWall(12 * 16, 0, 2 * 16, threeEigths, 0, -0.45, 0, 10), fireMovingWall(12 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.45, 0, 10), fireMovingWall(14 * 16, 0, 2 * 16, threeEigths, 0, -0.35, 0, 10), fireMovingWall(14 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.35, 0, 10), fireMovingWall(16 * 16, 0, 2 * 16, threeEigths, 0, -0.2, 0, 10), fireMovingWall(16 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.2, 0, 10), fireMovingWall(18 * 16, 0, 2 * 16, threeEigths, 0, -0.1, 0, 10), fireMovingWall(18 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.1, 0, 10), fireMovingWall(20 * 16, 0, 2 * 16, threeEigths, 0, -0.15, 0, 10), fireMovingWall(20 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.15, 0, 10), fireMovingWall(22 * 16, 0, 2 * 16, threeEigths, 0, -0.27, 0, 10), fireMovingWall(22 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.27, 0, 10), fireMovingWall(24 * 16, 0, 2 * 16, threeEigths, 0, -0.4, 0, 10), fireMovingWall(24 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.4, 0, 10), fireMovingWall(26 * 16, 0, 2 * 16, threeEigths, 0, -0.5, 0, 10), fireMovingWall(26 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.5, 0, 10), fireMovingWall(28 * 16, 0, 2 * 16, threeEigths, 0, -0.55, 0, 10), fireMovingWall(28 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.55, 0, 10), fireMovingWall(30 * 16, 0, 2 * 16, threeEigths, 0, -0.6, 0, 10), fireMovingWall(30 * 16, fiveEigths, 2 * 16, fullScreen, 0, -0.6, 0, 10), createActivePoint(pointEight - 8, pointOne - 8, 5.1)]);
                    ...
                    case 20:
                        ...
                        _context.next = 24;
                        return Promise.all([createActivePoint(pointOne - 8, pointEight - 8, 0), createWall(0, 0, sevenEigths, oneEigth), fireContinuallyMovingWall(-fullScreen, oneEigth, fullScreen, oneEigth, 1.5, 0, 0, 4.98), fireContinuallyMovingWall(oneEigth, oneEigth, fullScreen, oneEigth, 1.5, 0, 0, 4.98), createWall(0, oneFourth, fullScreen, 2 * 16), fireContinuallyMovingWall(-oneEigth, 10 * 16, fullScreen, oneEigth, -1.5, 0, 0, 4.98), fireContinuallyMovingWall(fullScreen, 10 * 16, fullScreen, oneEigth, -1.5, 0, 0, 4.98), createWall(0, 14 * 16, fullScreen, 2 * 16), createWall(0, oneHalf, 2 * 16, oneEigth), loopFireBombs(2 * 16, oneHalf, oneEigth, oneEigth, 0, 4, 1), createWall(6 * 16, oneHalf, 2 * 16, oneEigth), loopFireBombs(8 * 16, oneHalf, oneEigth, oneEigth, 3, 4, 1), createWall(12 * 16, oneHalf, 2 * 16, oneEigth), loopFireBombs(14 * 16, oneHalf, oneEigth, oneEigth, 0, 4, 1), createWall(18 * 16, oneHalf, 2 * 16, oneEigth), loopFireBombs(20 * 16, oneHalf, oneEigth, oneEigth, 3, 4, 1), createWall(24 * 16, oneHalf, 2 * 16, oneEigth), loopFireBombs(26 * 16, oneHalf, oneEigth, oneEigth, 0, 4, 1), createWall(30 * 16, oneHalf, 2 * 16, oneEigth), createWall(0, 20 * 16, fullScreen, 2 * 16), loopFireBombs(0, 22 * 16, oneFourth, oneEigth, 0, 0, 1000000), fireContinuallyMovingWall(oneFourth, 22 * 16, 2 * 16, oneEigth, 2, 0, 0, 1.9), loopFireBombs(threeFourths, 22 * 16, oneFourth, oneEigth, 0, 0, 1000000), createWall(0, 26 * 16, fullScreen, 2 * 16), loopFireBombs(0, sevenEigths, fullScreen, oneEigth, 0, 2, 1)]);
...
var createWall = function () {
    var _ref29 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee29(x, y, width, height) {
        var instance;
    ...
    return function createWall(_x74, _x75, _x76, _x77) {
...
var loopFireMovingWalls = function () {
    ...
    return function loopFireMovingWalls(_x78, _x79, _x80, _x81, _x82, _x83, _x84, _x85, _x86) {
...
var fireMovingWall = function () {
    ...
    return function fireMovingWall(_x87, _x88, _x89, _x90, _x91, _x92, _x93, _x94) {
...
var fireContinuallyMovingWall = function () {
    ...
    return function fireContinuallyMovingWall(_x95, _x96, _x97, _x98, _x99, _x100, _x101, _x102) {
...
var playCutscene = function () {
    var _ref33 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee33(scene, secondsPerFrame) {
    ...
    return function playCutscene(_x103, _x104) {
