        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 4:
                        _context.next = 6;
                        return Promise.all([fireMovingHorizontalLaser(0, 16, 1, 0, 7), fireMovingVerticalLaser(0, 16, 1, 0, 7), fireHorizontalLaser(200, 16, 1, 4), createPoint(400, 400, 0, 5)]);
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 4;
                        return createPoint(400, 400, 0, 5);

                    case 4:
                        _context2.next = 6;
                        return fireBomb(400, 400, 24, 24, 1, 5);
