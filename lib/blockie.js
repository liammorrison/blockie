            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 5;
                        return Promise.all([createWall(oneEigth, 0, pointThree, oneEigth), createWall(pointFive, 0, threeEigths, oneEigth), createWall(oneEigth, sevenEigths, pointThree, oneEigth), createWall(pointFive, sevenEigths, threeEigths, oneEigth), createWall(0, 0, oneEigth, fullScreen), createWall(sevenEigths, 0, oneEigth, fullScreen), createActivePoint(oneHalf - 8, pointEight - 8, 0), fireContinuallyMovingBomb(oneEigth, oneEigth, threeFourths, pointOne, 0, 1.4, 0, 4.2), fireContinuallyMovingBomb(oneEigth, pointSeven, threeFourths, pointOne, 0, -1.4, 0, 4.2), fireContinuallyMovingBomb(threeFourths, oneEigth, oneEigth, threeFourths, -1.28, 0, 0, 4.2)]);
