            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return Promise.all([createActivePoint(fiveSixths - 8, fiveSixths - 8, 0, 11), fireHorizontalLaser(oneThird - 8, 16, 3, 2), fireVerticalLaser(oneThird - 8, 16, 3, 2)]);
                    ...
                    case 4:
                        ...
                        _context.next = 7;
                        return Promise.all([createActivePoint(center - 8, center - 8, 0, 19), createWall(oneThird, oneThird, 7 * 16, 20 * 16), createWall(13 * 16, 19 * 16, 6 * 16, 7 * 16), createWall(19 * 16, 0, 13 * 16, twoThirds), fireBomb(10, 100, 100, 100, 1, 10)]);
