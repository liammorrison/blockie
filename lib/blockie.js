            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 6;
                        return Promise.all([createWall(oneEigth, oneHalf, sevenEigths, oneEigth), createWall(0, threeFourths, sevenEigths, oneEigth), fireBomb(0, oneHalf, oneEigth, oneEigth, 0, 4.5), fireBomb(11 * 16, fiveEigths, fiveSixteenths, oneEigth, 0, 0.75), fireBomb(11 * 16, fiveEigths, fiveSixteenths, oneEigth, 2.25, 0.75), fireBomb(11 * 16, fiveEigths, fiveSixteenths, oneEigth, 4.5, 0.75), fireBomb(11 * 16, sevenEigths, fiveSixteenths, oneEigth, 1.125, 0.75), fireBomb(11 * 16, sevenEigths, fiveSixteenths, oneEigth, 3.375, 0.75), fireBomb(0, oneHalf, oneEigth, oneEigth, 7, 1000000), fireBomb(0, fiveEigths, fullScreen, oneEigth, 7, 1000000), fireBomb(sevenEigths, threeFourths, oneEigth, oneEigth, 7, 1000000), fireBomb(0, sevenEigths, fullScreen, oneEigth, 7, 1000000), fireBomb(threeSixteenths, oneEigth, 3 * 16, 3 * 16, 7.5, 2), fireBomb(oneSixteenth, oneFourth, 3 * 16, 3 * 16, 7.5, 2), fireBomb(threeSixteenths, oneFourth, 3 * 16, 3 * 16, 7.5, 2), fireBomb(fiveSixteenths, oneFourth, 3 * 16, 3 * 16, 7.5, 2), fireBomb(elevenSixteenths, oneEigth, 3 * 16, 3 * 16, 7.5, 2), fireBomb(nineSixteenths, oneFourth, 3 * 16, 3 * 16, 7.5, 2), fireBomb(elevenSixteenths, oneFourth, 3 * 16, 3 * 16, 7.5, 2), fireBomb(thirteenSixteenths, oneFourth, 3 * 16, 3 * 16, 7.5, 2), fireMovingBomb(-threeFourths, 0, threeFourths, oneHalf, 0.34, 0, 9.5, 11.5), createActivePoint(oneHalf - 8, fiveSixteenths - 8, 21), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 9.5, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 10.62, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 11.74, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 12.86, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 13.98, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 15.1, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 16.22, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 17.34, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 18.46, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 19.58, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 20.7, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 21.82, 7), fireMovingBomb(fullScreen, 0, oneSixteenth, oneHalf, -2, 0, 22.94, 7)]);
                    ...
                    case 6:
                        ...
                        _context.next = 10;
                        return Promise.all([createWall(0, 0, sevenSixteenths, fullScreen), createWall(sevenSixteenths, 0, oneEigth, oneSixteenth), createWall(sevenSixteenths, threeSixteenths, oneEigth, oneSixteenth), createWall(sevenSixteenths, threeEigths, oneEigth, oneSixteenth), createWall(sevenSixteenths, nineSixteenths, oneEigth, oneSixteenth), createWall(sevenSixteenths, threeFourths, oneEigth, oneSixteenth), createWall(sevenSixteenths, fifteenSixteenths, oneEigth, oneSixteenth), createWall(nineSixteenths, 0, sevenSixteenths, fullScreen), fireMovingHorizontalLaser(0, oneSixteenth, 1.2, 0, 3.98), fireMovingHorizontalLaser(fifteenSixteenths, oneSixteenth, -0.4, 0, 3.98), fireMovingHorizontalLaser(0, oneSixteenth, 1.2, 4, 7), fireMovingHorizontalLaser(0, oneEigth, 1.2, 7, 4.85), fireMovingHorizontalLaser(0, oneSixteenth, 3.2, 11, 3.5), createActivePoint(oneHalf - 8, oneHalf - 8, 16), fireMovingBomb(thirteenSixteenths, oneSixteenth, oneEigth, oneEigth, -2, 0, 15, 1.6), fireMovingBomb(oneSixteenth, oneFourth, oneEigth, oneEigth, 2, 0, 15, 1.6), fireMovingBomb(thirteenSixteenths, fiveEigths, oneEigth, oneEigth, -2, 0, 15, 1.6), fireMovingBomb(oneSixteenth, thirteenSixteenths, oneEigth, oneEigth, 2, 0, 15, 1.6)]);
                    ...
                    case 10:
                        ...
                        _context.next = 13;
                        return Promise.all([createWall(oneEigth, oneEigth, threeFourths, oneEigth), createWall(oneFourth, threeEigths, oneHalf, oneSixteenth), createWall(oneFourth, nineSixteenths, oneHalf, oneSixteenth), createWall(oneEigth, threeFourths, threeFourths, oneEigth), createWall(oneEigth, oneFourth, oneEigth, oneHalf), createWall(threeEigths, oneFourth, oneSixteenth, oneHalf), createWall(nineSixteenths, oneFourth, oneSixteenth, oneHalf), createWall(threeFourths, oneFourth, oneEigth, oneHalf), fireMovingWall(0, -oneEigth, 36 * 16, oneEigth, -1.8, 1.8, 0, 2.9), fireMovingWall(fullScreen, -oneEigth, oneEigth, 36 * 16, -1.8, 1.8, 0, 2.9), fireMovingWall(-oneEigth, fullScreen, 36 * 16, oneEigth, 1.8, -1.8, 3, 2.9), fireMovingWall(-oneEigth, 0, oneEigth, 36 * 16, 1.8, -1.8, 3, 2.9), fireMovingWall(0, -oneEigth, fullScreen, oneEigth, 0, 2.3, 5.9, 2.28), createActivePoint(oneHalf - 8, oneHalf - 8, 10.4), fireMovingWall(0, -fullScreen, fullScreen, fullScreen, 0, 1.5, 9, 4), fireMovingWall(-fullScreen, 0, fullScreen, fullScreen, 1.5, 0, 9, 4), fireMovingWall(0, fullScreen, fullScreen, fullScreen, 0, -1.5, 9, 4), fireMovingWall(fullScreen, 0, fullScreen, fullScreen, -1.5, 0, 9, 4)]);
            ...
            while (1) {
                switch (_context14.prev = _context14.next) {
                    case 0:
                        ...
                        _context14.next = 17;
                        return displayMessage("Determination is your only asset.", true);
                    ...
                    case 28:
                        _context14.next = 30;
                        return displayMessage("You've failed another world.", true);
        ...
        return regeneratorRuntime.wrap(function _callee15$(_context15) {
            while (1) {
                switch (_context15.prev = _context15.next) {
                    ...
                    case 8:
                        _context15.next = 10;
                        return displayMessage("You haven't escaped yet.", true);
...
var displayMessage = function () {
    var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(message, changeLevel) {
