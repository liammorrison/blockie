        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 4:
                        _context.next = 6;
                        return Promise.all([fireHorizontalLaser(100, 16, 2), fireBomb(200, 200, 64, 64, 2), fireMovingHorizontalLaser(350, 16, -2, 3), fireMovingVerticalLaser(100, 32, 1, 4)]);
...
function fireMovingHorizontalLaser(y, height, speed, totalSeconds) {
    //Creates an instance and sets all of its key-value pairs.
    var instance = new movingHorizontalLaser();
...
function fireMovingVerticalLaser(x, width, speed, totalSeconds) {
    //Creates an instance and sets all of its key-value pairs.
    var instance = new movingVerticalLaser();
