...
var passivePointColor = "#91FF00";
var activePointColor = "#00D900";
...
//in the game).
var tapKeys = [16, 32, 37, 38, 39, 40, 73, 79, 80];
...
function initializeOpeningScreenMenu() {
    ...
    function exitOpeningMenu(selectedIcon) {
        ...
        for (var _i3 = 0; _i3 < openingMenuIconArray.length; _i3++) {
            openingMenuIconArray[_i3].style.visibility = "hidden";
        };
        ...
        var _loop3 = function _loop3(_i4) {
            openingMenuIconArray[_i4].removeEventListener("click", function () {
                exitOpeningMenu(openingMenuIconArray[_i4]);
            });
        };
        ...
        var _loop4 = function _loop4(_i5) {
            openingMenuIconArray[_i5].removeEventListener("mouseover", function () {
                if (followMouse) {
                    //Dehighlights the previously highlighted icon as the mouse may be over a different icon, which is then highlighted.
                    revertLevelIcon(openingHoveringIconNum);
                    openingHoveringIconNum = _i5;
                    highlightLevelIcon(openingHoveringIconNum);
                };
            });
        };
...
function initializeLevelMenu() {
    ...
    var _loop5 = function _loop5(_i6) {
        levelMenuIconArray[_i6].addEventListener("click", function () {
    ...
    var _loop6 = function _loop6(_i7) {
        levelMenuIconArray[_i7].addEventListener("mouseover", function () {
            if (followMouse) {
                //Dehighlights the previously highlighted icon as the mouse may be over a different icon, which is then highlighted.
                revertLevelIcon(levelHoveringIconNum);
                levelHoveringIconNum = _i7;
    ...
    function beginSelectedLevel(iconNum) {
        ...
        for (var _i8 = 0; _i8 < numUnlockedLevels; _i8++) {
            levelMenuIconArray[_i8].style.visibility = "hidden";
        };
        ...
        var _loop7 = function _loop7(_i9) {
            levelMenuIconArray[_i9].removeEventListener("click", function () {
                beginSelectedLevel(_i9 + 1);
            });
        };
        ...
        var _loop8 = function _loop8(_i10) {
            levelMenuIconArray[_i10].removeEventListener("mouseover", function () {
                if (followMouse) {
                    revertLevelIcon(levelHoveringIconNum);
                    levelHoveringIconNum = _i10;
                    highlightLevelIcon(levelHoveringIconNum);
                };
            });
        };
...
function stopUniqueTimingEvents() {
    ...
    for (var _i11 = 0; _i11 < uniqueIntervals.length; _i11++) {
        clearInterval(uniqueIntervals[_i11]);
    };
...
function checkCollisionsWithClasses(classesArray) {
    ...
    for (var i = 0; i < classesArray.length; i++) {
        ...
        for (var _i12 = 0; _i12 < currentClass.length; _i12++) {
            checkInstancesColliding(blockie, currentClass[_i12]);
        };
    };
};
...
function checkTestCollisionsWithClasses(instanceOneX, instanceOneY, classesArray) {
    ...
    for (var i = 0; i < classesArray.length; i++) {
        var currentClass = classesArray[i];
        for (var _i13 = 0; _i13 < currentClass.length; _i13++) {
            checkTestInstancesColliding(blockie, instanceOneX, instanceOneY, currentClass[_i13]);
        };
    };
};
