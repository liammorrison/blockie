            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return Promise.all([createPoint(100, 100, 0, 7), fireMovingHorizontalLaser(24 * 16, 16, -1, 0, 4.5)]);
...
var fireBomb = function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(x, y, width, height, waitingSeconds, activeSeconds) {
        var instance;
    ...
    return function fireBomb(_x13, _x14, _x15, _x16, _x17, _x18) {
...
function removeCurrentPromiseRejectFunction(reject) {
    var currentPromiseRejectFunctionIndex = currentPromiseRejectFunctions.indexOf(reject);
