            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 4;
                        return createPoint(center - 8, 8 * 16, 0, 10);

                    case 4:
                        _context.next = 6;
                        return Promise.all([createPoint(center - 8, center - 12, 0, 5), fireMovingHorizontalLaser(maxEdge - 16, 16, -0.75, 1, 4), fireMovingVerticalLaser(0, 16, 0.75, 1, 4), fireMovingVerticalLaser(maxEdge - 16, 16, -0.75, 1, 4), fireMovingHorizontalLaser(0, 16, 1.5, 3, 2)]);

                    case 6:
                        _context.next = 8;
                        return Promise.all([createPoint(center - 8, 6 * 16, 0, 3), fireVerticalLaser(12 * 16, 16, 0, 3), fireVerticalLaser(19 * 16, 16, 0, 3), fireMovingHorizontalLaser(30 * 16, 32, -1.75, 0, 3)]);

                    case 8:
                        _context.next = 10;
                        return Promise.all([createPoint(6 * 16, center, 0, 2.5), fireMovingHorizontalLaser(0, 32, 1.4, 0, 3.5), fireMovingVerticalLaser(19 * 16, 32, -1.4, 0, 1.75), fireMovingVerticalLaser(0, 32, 1.4, 1.75, 3.5), createPoint(center, 25 * 16, 2.5, 2.5), fireMovingHorizontalLaser(maxEdge - 32, 32, -1.4, 3.5, 3.5), createPoint(25 * 16, center, 5, 2.5), fireMovingVerticalLaser(maxEdge - 32, 32, -1.4, 5.25, 1.75)]);

                    case 10:
                        _context.next = 12;
                        return Promise.all([createPoint(center - 8, center - 8, 0, 12), fireBomb(center - 32, center - 32, 64, 64, 0, 6)]);
...
var fireHorizontalLaser = function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(y, height, waitingSeconds, firingSeconds) {
        var instance;
...
var fireVerticalLaser = function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(x, width, waitingSeconds, firingSeconds) {
        var instance;
...
var fireMovingHorizontalLaser = function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(y, height, speed, waitingSeconds, firingSeconds) {
        var instance;
...
var fireMovingVerticalLaser = function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(x, width, speed, waitingSeconds, firingSeconds) {
        var instance;
...
var fireBomb = function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(x, y, width, height, waitingSeconds, firingSeconds) {
        var instance;
