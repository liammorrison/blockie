...
//in the game).
var tapKeys = [16, 32, 37, 38, 39, 40, 79, 80];
...
function initializeOpeningScreenMenu() {
    ...
    var newGameMenuIcon = document.getElementById("newGameMenuIcon");
    newGameMenuIcon.style.visibility = "visible";

    newGameMenuIcon.addEventListener("click", function () {
        localStorage.clear();
        exitMenu();
    });
    ...
    if (localStorage.getItem("currentLevelNum")) {
        var _continueGameMenuIcon = document.getElementById("continueGameMenuIcon");
        _continueGameMenuIcon.style.visibility = "visible";

        _continueGameMenuIcon.addEventListener("click", function () {
            exitMenu();
        });
    };

    function exitMenu() {
        newGameMenuIcon.removeEventListener("click", function () {
            localStorage.clear();
            exitMenu();
        });

        continueGameMenuIcon.removeEventListener("click", function () {
            exitMenu();
        });
...
function initializeLevelMenu() {
    ...
    var _loop = function _loop(_i) {
        levelMenuIconArray[_i].addEventListener("click", function () {
            beginSelectedLevel(_i + 1);
        });
    };

    for (var _i = 0; _i < numUnlockedLevels; _i++) {
        _loop(_i);
    };
    ...
    function beginSelectedLevel(iconNum) {
        ...
        for (var _i2 = 0; _i2 < numUnlockedLevels; _i2++) {
            levelMenuIconArray[_i2].style.visibility = "hidden";
        };

        //Removes all menu-specific eventListeners and timers.

        var _loop2 = function _loop2(_i3) {
            levelMenuIconArray[_i3].removeEventListener("click", function () {
                beginSelectedLevel(_i3 + 1);
            });
        };
        ...
        var _loop3 = function _loop3(_i4) {
            levelMenuIconArray[_i4].removeEventListener("mouseover", function () {
                if (followMouse) {
                    revertLevelIcon(hoveringIconArrayNum);
                    hoveringIconArrayNum = _i4;
                    highlightLevelIcon(hoveringIconArrayNum);
                };
            });
        };
    ...
    var _loop4 = function _loop4(_i5) {
        levelMenuIconArray[_i5].addEventListener("mouseover", function () {
            if (followMouse) {
...
function stopUniqueTimingEvents() {
    ...
    for (var _i6 = 0; _i6 < uniqueIntervals.length; _i6++) {
        clearInterval(uniqueIntervals[_i6]);
    };
...
function checkCollisionsWithClasses(classesArray) {
    ...
    for (var i = 0; i < classesArray.length; i++) {
        ...
        for (var _i7 = 0; _i7 < currentClass.length; _i7++) {
            checkInstancesColliding(blockie, currentClass[_i7]);
        };
    };
};
...
function checkTestCollisionsWithClasses(instanceOneX, instanceOneY, classesArray) {
    ...
    for (var i = 0; i < classesArray.length; i++) {
        ...
        for (var _i8 = 0; _i8 < currentClass.length; _i8++) {
            checkTestInstancesColliding(blockie, instanceOneX, instanceOneY, currentClass[_i8]);
        };
    };
};
