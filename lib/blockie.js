        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 4:
                        _context.next = 6;
                        return createPoint(100, 100, 2, 7);
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        _context4.next = 2;
                        return createWaitingTimer(waitingSeconds);
...
var waitingTimer = function waitingTimer(externalReject, timer) {
...
function createWaitingTimer(waitingSeconds) {
    return new Promise(function (resolve, reject) {
        ...
        var instance = new waitingTimer(reject, stopWaiting);
