            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 4:
                        ...
                        _context.next = 7;
                        return Promise.all([createActivePoint(center - 8, center - 8, 0, 19), createWall(oneThird, oneThird, 7 * 16, 20 * 16), createWall(13 * 16, 19 * 16, 6 * 16, 7 * 16), createWall(19 * 16, 0, 13 * 16, twoThirds)]);
